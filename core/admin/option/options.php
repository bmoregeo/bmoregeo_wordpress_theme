...
/* START LAYOUT */ 
	...
	array( "name" => __( "Header Sidebar Area Layout","wip"),
	       ...
	       "type" => "select",
	       "options" => array(
		   "col-xs-24 col-md-12" => __( "One Column","wip"),
	   	   "col-xs-12 col-md-6" => __( "Two Columns","wip"),
	   	   "col-xs-8 col-md-4" => __( "Three Columns","wip"),
	   	   "col-xs-6 col-md-3" => __( "Four Columns","wip"),
		   ),
	       "std" => "col-xs-24 col-md-12"),
